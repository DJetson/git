...
{
    public class GameObject : INotifyPropertyChanged, IColorObject, IPositionInfo, IGameObject //ISensoryInfo
    {
        ...
        private Brush _Fill = new SolidColorBrush(Colors.Black);
        private Brush _Stroke = new SolidColorBrush(Colors.Black);
        private Vector _Size = new Vector(25, 25);
        private Vector _Scale = new Vector(1, 1);
        private BoundedVector _Position = new BoundedVector(100, 100);
        private BoundedVector _Velocity = new BoundedVector(0, 0);
        private BoundedVector _Acceleration = new BoundedVector(0, 0);
        ...
        public void GetGamepadInput()
        {
            ...
            {
                //System.Diagnostics.Trace.WriteLine(String.Format("GamePad:{0}",WorldObject.PlayerOneInput.LeftStick.Position));
                System.Diagnostics.Trace.WriteLine(String.Format("Object:{0}", Velocity.Current));
