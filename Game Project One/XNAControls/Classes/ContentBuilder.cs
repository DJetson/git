...
namespace XnaControls.Classes
{
    ...
    public class ContentBuilder : IDisposable
    {
        ...
        /// </summary>
        public void Add(string filename, string name, string importer = null, string processor = null)
        {
        ...
        /// <summary>
        /// Removes a content file from the MSBuild project
        /// </summary>
        ...
        public void Remove(string name)
        {
            ...
            foreach (ProjectItem p in projectItems)
                if (p.GetMetadataValue("Name") == name)
                    ToRemove = p;

            projectItems.Remove(ToRemove);
        }
